...
const BookAppointment = ({toggleBkAptModal,doctorNameForAppointment}) => {
    ...
    return (
        ...
        <form autoComplete="off" onSubmit= {handleBookAppointmentSubmit}>
            <FormControl className={classes.root} required>
                <InputLabel htmlFor="doctorName" className={classes.MuiInputLabelRegister}>{doctorNameForAppointment}</InputLabel>
